...
Form generator component for vue. Build forms using components from multiple component libraries.

## Demo

[Nuxt generated](https://divijbhardwaj.github.io/form-generator-vue-demo/)

## Features

* reactive schema based form.
* supports third party component libraries.
* custom components.
